       ...
       <div class="container">
           <div class="reviews_form">
                <div class="input-section">
                    <h1 class="side_blocks" >Техническая поддержка</h1>
                    <form class="input-group" method="post" action="db.php">
                        ...
                        <input name="mail" class="input E-mail" type = "text" id="E-mail" placeholder="E-mail*" required> <br>                        <textarea type = "text" class="textarea_reviews" id="textarea_reviews" placeholder="Проблема*" name="message" required></textarea>
